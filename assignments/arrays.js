...
//`Car 33 is a *car year goes here* *car make goes here* *car model goes here* (id: 33, car_make: "Jeep", car_model: "Wrangler", car_year: 2011)
...
let BMWAndAudi = [];
  for(let i=0; i < inventory.length; i++){
    if(inventory[i].car_make=== "BMW" || inventory[i].car_mark === "Audi"){
